...
OUTCOME_VAR <- "p_factor_mcelroy_harmonized_all_samples"
...
saveRDS(final_summary_table, "final_summary_table_pfactor_ridge.rds")
saveRDS(all_median_preds,    "all_median_preds_pfactor_ridge.rds")
saveRDS(all_preds_raw,       "all_preds_raw_pfactor_ridge.rds")
saveRDS(all_raw_splits,      "all_raw_splits_pfactor_ridge.rds")